...
class MSMT17(object):
    ...
    def __init__(self, root='data', comebineall=True, **kwargs):
        self.name = "msmt"
        ...
        val = self._process_dir(self.train_dir, self.list_train_path)
        ...
        if comebineall:
            ...
            for item in gallery:
                item[1] = item[1] + 1041
            self.train.extend(self.query)
            self.train.extend(self.gallery)
